...
export default function Attendance() {
  ...
  useEffect(() => {
    ...
    if (storedSettings) {
      ...
      setOfficeStartTime(settings.officeStartTime || "08:00");
    }
  }, []);
  ...
  const handleUpdateAttendance = (
    ...
    if (!isAdmin) {
      toast({
        ...
        description: "Only administrators can edit attendance records",
        variant: "destructive",
      });
      return;
    }
      ...
      <div className="w-full px-6 py-6 flex-1 print:p-0">
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Track and manage employee attendance (Office starts at {officeStartTime})
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Record daily attendance for all employees (Late auto-marked if arrival after {officeStartTime})
              </CardDescription>
            </CardHeader>
                                ...
                                {isAdmin ? (
                                  ...
                                  <Badge
                                    ...
                                    className={
                                      ...
                                      record?.status === "Absent" ? "bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300" :
