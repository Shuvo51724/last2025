...
import type { ExpenseSheet, ExpenseItem, AdminSettings } from "@shared/schema";
...
export default function ExpenseSheetPage() {
  ...
  useEffect(() => {
    ...
    if (storedSettings) {
      ...
      setHeaderSettings({
        title: settings.expenseHeaderTitle || "Daily Our Bangladesh",
        subtitle: settings.expenseHeaderSubtitle || "Expense Month of",
        preparedBy: settings.expensePreparedBy || "Administrator",
      });
    }
  }, []);
