                              ...
                              <>
                                ...
                                <div className="flex gap-2 pt-2 border-t">
                                  ...
                                  <AlertDialog>
                                    ...
                                    <AlertDialogContent>
                                      <AlertDialogHeader>
                                        <AlertDialogTitle>Delete Employee Credential?</AlertDialogTitle>
                                        <AlertDialogDescription>
              ...
              <Card className="border-green-200 dark:border-green-900">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-green-700 dark:text-green-400">Super Employee Management</CardTitle>
                  </div>
                  <CardDescription>Create super employees with custom permissions</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <Dialog open={showAddSuperMod} onOpenChange={setShowAddSuperMod}>
                    ...
                    <DialogContent className="max-w-md">
                      <DialogHeader>
                        <DialogTitle>Add Super Employee</DialogTitle>
                        <DialogDescription>
                          Create a new super employee with customizable permissions
                        </DialogDescription>
                      </DialogHeader>
                      <div className="space-y-3">
                        <div className="space-y-1.5">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-semibold text-sm">Super Employees ({superModerators.length})</h3>
                    {superModerators.length === 0 ? (
                      <p className="text-sm text-muted-foreground text-center py-6">
                        No super employees yet. Create one to get started.
                      </p>
                    ) : (
                            ...
                            <AlertDialog>
                              <AlertDialogTrigger asChild>
                                <Button size="sm" variant="destructive" className="w-full gap-1">
                                  <Trash2 className="w-3 h-3" />
                                  Delete Super Employee
                                </Button>
                              </AlertDialogTrigger>
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  <AlertDialogTitle>Delete Super Employee?</AlertDialogTitle>
                                  <AlertDialogDescription>
